######################################################################
print(">>>>> Running latest version of Milestone3.py <<<<<")
#VERSION = "Milestone3 - Final Copy - June 2025"
# raspberry pi path, not the local computer path:
#EXPECTED_PATH = "/home/shaynamitchell/cs350/Module-5/Milestone3.py"
#####    Running instructions via terminal:    #####
##copy new edits to:
# scp ~/Documents/ShaynaWorkspace/School/CS-350/Module-5/Milestone3.py shaynamitchell@192.168.12.179:~/cs350/Module-5/
## and run like this:
# cd ~/cs350/Module-5
...
##      Milestone Three Lab Input with Buttons     ##
##      This VERSION Reviewed by Dr. Wilson!       ##
#####                                           #####
#
...
#    print("Tip: Copy the correct file to the Pi and run from ~/cs350/Module-5")
#    sys.exit(1)
#else:
...
#####
##                Milestone3.py                   ##
# This is the Python code template used to
...
class ManagedDisplay():
    ...
    ## At one point I had this part deleted and I replaced it.
    ##
    def clear(self):
        self.lcd.clear()
    ##
    ...
    ##
#
#     I noticed that after typing ctrl+c via terminal to end the program -
#     it ended cleanly - but there was an error displayed after program end -
#     because the abrupt halt in the program caused 2 methods to fight eachother
#     or have to halt in the middle of tasks. Not an issue to the program running
#     and ending properly, but can be avoided with a catch probably here
#     in the manageDisplay class.
#
#
...
##
    ...
    def on_exit_dot(self):
        self.redLight.off()
                ...
                ## ADDED HERE SM  Add the single line of code necessary to ensure that the
    ...
    def on_enter_dash(self):
        ...
        if (DEBUG):
            print("* Changing state to blue - dash")
                ...
                ### ADDED HERE SM    Add the single line of code necessary to blink the Blue
                ## LED for 1500ms one time.
    ...
    def on_enter_dotDashPause(self):
        ...
        if(DEBUG):
            print("* Pausing Between Dots/Dashes - 250ms")
                ...
                ## wait for 250ms
                ## ADDED HERE SM    Add the single line of code necessary to pause execution
                ## of the next operation for 250ms.
    ...
    def toggleMessage(self):
        ...
        if (DEBUG):
            print(f"* Toggling active message to: {self.activeMessage} ")
                ## toggleMessage - method used to switch between message1 and message2
                ## ADDED HERE SM     Add the code necessary to toggle the activeMessage
                ## between the primary message of 'SOS' and the backup message of OK
        ...
        while not self.endTransmission:
            ...
            for word in wordList:
                ...
                for char in word:
                    ...
                    for x in morse:
                            ## Dot or dash?##
                            ## ADDED HERE SM    Add the code necessary code to determine if
...
## At some point I changed the order of .run() but this is the original order:
cwMachine = CWMachine()
cwMachine.run()
        ## Initial Code Button Section:
        ...
        # my physical button is actually the color yellow #
greenButton = Button(24)
        ## ADDED HERE SM for the ToDo      Add the code necessary code to assign the
...
greenButton.when_pressed = cwMachine.processButton
        #At one time I had this line here as Begin program or .run():
        #cwMachine.run()
##
##Sleep Loop
## Setup loop variable
...
while repeat:
    try:
        ...
        cwMachine.endTransmission = True
            # ADDITIONALLY ADDED this one line-HERE :
            #make sure lcd screen cleared with safe shutdown.
        cwMachine.screen.cleanupDisplay()
                #This sleep was already here:
        sleep(1)
#
# END OF MILESTONE THREE MORSE CODE PROJECT FILE CS350 Emerging Systems SM June 2025
#####
